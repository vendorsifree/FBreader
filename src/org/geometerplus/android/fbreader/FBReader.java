...
public final class FBReader extends ZLAndroidActivity {
	...
	public static final String BOOK_STORE_STORAGE = "BookStore";
	public static final String INTENT_HAS_BOOK_PATH = "HAS_BOOK_PATH";
	public static final String OPEN_BOOK_STORE = "OPEN_BOOK_STORE";
	...
	public void onCreate(Bundle icicle) {
		...
		HackedLog.i(">>> INTENT >>>>", getIntent().toString());
		
		SharedPreferences.Editor spe = getSharedPreferences(BOOK_STORE_STORAGE, MODE_PRIVATE).edit();
		spe.putBoolean(INTENT_HAS_BOOK_PATH, getIntent().hasExtra("BookPath"));
		spe.commit();
	...
	public void onResume() {
		super.onResume();
		SharedPreferences sp = getSharedPreferences(BOOK_STORE_STORAGE, MODE_PRIVATE);
		SharedPreferences.Editor spe = sp.edit();
		if (sp.getBoolean(OPEN_BOOK_STORE, false)) {
			spe.putBoolean(OPEN_BOOK_STORE, false);
			spe.commit();
			HackedLog.i("----$$$----", "-------------> FBReader.onResume...");
			finish();
		} else {
			try {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		addMenuItem(menu, ActionCode.BACK_TO_BOOKSTORE);
