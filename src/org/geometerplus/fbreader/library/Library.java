...
import org.geometerplus.fbreader.tree.FBTree.Status;
import org.geometerplus.fbreader.Paths;
import org.geometerplus.fbreader.bookmodel.BookReadingException;

public final class Library extends AbstractLibrary {
	public static final String ROOT_BOOKSTORE = "bookstore";
	...
	public Library(BooksDatabase db) {
		...
		new BookStoreTree(myRootTree, ROOT_BOOKSTORE);
	...
	public class BookStoreTree extends FirstLevelTree {
		
		BookStoreTree(RootTree root, String id) {
			super(root, id);
		}
